...
<main id="primary" class="site-main">
    ...
    <section class="section-padding dark-bg">
        <div class="max-w-[1200px] mx-auto px-8">
            <div class="glass-panel fade-in-up" style="padding: var(--spacing-lg); border-radius: 24px; text-align: center;">
                <h2 style="font-size: 2.5rem; margin-bottom: 2rem;">Our <span class="accent">Mission & Vision</span></h2>
                <p style="font-size: 1.2rem; line-height: 1.8; color: var(--text-main); max-width: 800px; margin: 0 auto 2rem auto;">
